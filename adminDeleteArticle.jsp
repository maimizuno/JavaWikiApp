		...
		<div class="delete_container">
			...
			<div class="delete_buttons">
				<form action="${pageContext.request.contextPath}/WikiServlet?" method="post">
					...
					<button class="delete_button" type="submit" name="action" value="deleteArticle">Delete</button>
					<input type="hidden"  name="admin" value="true"/> 
					<button class="cancel_button" type="submit" name="action" value="listArticles">Cancel</button>
				</form>
			</div>
		</div>
