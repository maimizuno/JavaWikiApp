...
<html>
	<head>
	    ...
	    <title>Wiki - Admin Search Results</title>
	</head>
	<body>
		<header class="header">
			<div class="top">
	    ...
	    <div class="articles">
			<!-- loop through each article if the keyword matches any records in the database -->
	        <c:if test="${not empty listArticles}">
	            <c:forEach items="${listArticles}" var="article">
	                <div class="article_container">
	                    ...
	                    <p class="content"><c:out value="${fn:substring(article.getContent(), 0, 200)}"/>...</p>
	                    <!-- link to read more -->
						<div class="read_more">
